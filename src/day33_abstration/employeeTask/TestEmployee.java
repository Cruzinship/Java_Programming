package day33_abstration.employeeTask;

public class TestEmployee {
    public static void main(String[] args) {
         //Employee employee = new Employee("Daniel", 45, 'M', "A1", "SDET",  85000);
         // we cannot not create objects from an abstract class, objects must be created class
    //}
