package day35_polymorhphism;

import day34_abstraction.animalTask.*;
import day35_polymorhphism.transportationTask.*;

public class PolymorphismPractice {
    public static void main(String[] args) {

        Animal tiger = new Tiger("Sher Khan", "Begal", 'M', 5, "Large", "Orange");
        ...
        boolean isTelsa = car instanceof Tesla;
        ...
        System.out.println("isTelsa = " + isTelsa);
